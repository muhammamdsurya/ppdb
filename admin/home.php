...
$jmlAdmin = query("SELECT COUNT(id) AS jml_adm FROM admin")[0];
$pendaftar = query("SELECT COUNT(id_data) AS jml_pdf FROM pendaftar")[0];
$user = query("SELECT COUNT(userid) AS jml_user FROM user")[0];
