              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nm_dpn" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $admin["nm_dpn"]; ?>">
                  </div>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Nama Belakang</label>
                    <input type="text" class="form-control" name="nm_blkg" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $admin["nm_blkg"]; ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $admin["adm_email"]; ?>">
                  </div>
                  <div class="mb-3">
