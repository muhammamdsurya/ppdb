...
$user = query("SELECT * FROM user LIMIT $awalData, $jmlHalamanPerData");
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data Akun Peserta</h6>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    <?php foreach ($user as $row) : ?>
                      <tr>
                        ...
                        <td>
                          <a href="controller/hapusUser.php?id=<?= $row["userid"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin Menghapus?')">Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
