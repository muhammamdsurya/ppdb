    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
        <div class="sidebar-brand-icon mt-4">
          <?php if (!empty($admin[0]["foto"]) && file_exists('../assets/img/' . $admin[0]["foto"])) : ?>
            <img src="../assets/img/<?= $admin[0]["foto"]; ?>" style="width: 70px; height: 70px" class="rounded-circle" alt="">
          <?php else : ?>
            <img src="../assets/img/person_2.jpg" style="width: 70px; height: 70px" class="rounded-circle" alt="">
          <?php endif; ?>
          <div class="sidebar-brand-text mx-3"><?= $admin[0]["nm_dpn"]; ?></div>
        </div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 "><?= $admin[0]["adm_email"]; ?></span>
                <?php if (!empty($admin[0]["foto"]) && file_exists('../assets/img/' . $admin[0]["foto"])) : ?>
                  <img src="../assets/img/<?= $admin[0]["foto"]; ?>" style="width: 50px; height: 50px" class="rounded-circle" alt="">
                <?php else : ?>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow">
            <div class="card-header py-3">
              ...
              <a class="btn btn-success mt-3" href="tambahAdm.php">+ Tambah</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    <?php foreach ($admin as $row) : ?>
                      <tr>
                        ...
                        <td><?= $row["adm_email"]; ?></td>
                        <td>
                          <a href="controller/hapusAdmin.php?id=<?= $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin Menghapus?')">Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
